            ...
            <>
              <Disclosure.Button
                className={`flex w-full ${
                  open && "bg-[#EFEFEF]"
                } justify-between hover:bg-[#EFEFEF] px-4 py-2 text-left text-sm font-medium border-t border-b   focus:outline-none focus-visible:ring `}
              >
          ...
          {({ open }) => (
            <>
              <Disclosure.Button
                className={`${
                  open && "bg-[#EFEFEF]"
                } flex w-full border-b justify-between hover:bg-[#EFEFEF] px-4 py-2 text-left text-sm font-medium   focus:outline-none focus-visible:ring `}
              >
