  ...
  return (
    <>
      <section className="mt-16 px-8">
        ...
        <div className="mt-5 hover:cursor-pointer flex items-center gap-2 hover:gap-4 text-xl font-semibold text-[#33B08D]">
          <h3>View our worldwide office locations</h3> <FaArrowRight />
        </div>
        <div className=" md:w-6/12 flex justify-between mt-16">
